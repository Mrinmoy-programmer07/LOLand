...
export default function HowItWorks() {
  ...
  const steps = [
    {
      icon: <Upload className="h-10 w-10 text-pink-400" />,
      title: "Create & Upload",
      description: "Create your funniest meme and upload it to the LOLand platform.",
      color: "from-pink-500 to-pink-600",
    },
    {
      icon: <Laugh className="h-10 w-10 text-purple-400" />,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-purple-900/40 backdrop-blur-sm rounded-3xl p-8 border border-purple-500/30 shadow-xl h-full flex flex-col items-center text-center hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 transform hover:scale-[1.02]">
                <div
        ...
        <div className="hidden lg:block relative h-0">
          <motion.div
            ...
            className="absolute top-[-120px] left-[25%] right-[25%] h-0.5 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500"
          />
        </div>
      </div>
    </section>
