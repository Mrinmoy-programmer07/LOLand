    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="flex justify-center mb-10">
        <Tabs defaultValue="all-time" className="w-full max-w-md" onValueChange={handleTimeframeChange}>
          <TabsList className="grid grid-cols-3 h-14 bg-purple-800/50 backdrop-blur-md rounded-full p-1">
            <TabsTrigger
              value="all-time"
      ...
      <div className="bg-purple-900/40 backdrop-blur-md rounded-3xl p-6 shadow-xl border border-purple-500/30">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-purple-700">
                <th className="px-4 py-4 text-left text-purple-200">Rank</th>
                <th className="px-4 py-4 text-left text-purple-200">Creator</th>
                <th className="px-4 py-4 text-right text-purple-200">Memes</th>
                <th className="px-4 py-4 text-right text-purple-200">Likes</th>
                <th className="px-4 py-4 text-right text-purple-200">Earnings</th>
                <th className="px-4 py-4 text-right text-purple-200">Badge</th>
              </tr>
            </thead>
            <tbody>
              {creators.map((creator, index) => (
                <motion.tr
                  ...
                  className="border-b border-purple-800/50 hover:bg-purple-800/20 transition-colors"
                >
                  ...
                  <td className="px-4 py-4 text-right text-purple-100">{creator.memes}</td>
                  <td className="px-4 py-4 text-right text-purple-100">
                    <div className="flex items-center justify-end">
                      <TrendingUp className="h-4 w-4 mr-1 text-pink-400" />
                      {creator.likes.toLocaleString()}
                    </div>
                  </td>
                  <td className="px-4 py-4 text-right font-bold text-green-400">{creator.earnings}</td>
                  <td className="px-4 py-4 text-right">
                    {creator.badge && (
                      <div className="inline-flex items-center px-3 py-1 rounded-full bg-purple-700/50 border border-purple-500">
